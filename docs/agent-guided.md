...
Use this mode when you want Codex to guide one MiniDist Stage interactively in
the terminal.

## 1. Open Codex in MiniDist
...
Replace `03` with any Stage from `01` through `10`. Codex prepares the correct
