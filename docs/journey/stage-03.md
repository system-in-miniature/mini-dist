# Stage 03 · Asynchronous primary replication
...
One mechanism block connects local acceptance, delayed delivery, backlog catch-up, and promotion loss.
...
Expose the learner-facing group and sync-mode vocabulary without treating import wiring as a protocol mechanism.
...
[Compare this stage on GitHub](https://github.com/system-in-miniature/mini-dist/compare/stage-02...stage-03)
