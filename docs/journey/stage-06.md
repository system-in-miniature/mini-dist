# Stage 06 · Promotion lineage fencing
...
Make promotion start a new generation and reject queued messages whose sender, generation, or replication lineage is stale.
...
Extend Experiment 3 so both async primary and Raft answer the same minority-authority question.
...
[Compare this stage on GitHub](https://github.com/system-in-miniature/mini-dist/compare/stage-05...stage-06)
